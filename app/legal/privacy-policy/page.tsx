      ...
      <div className={styles.legalContainer}>
        ...
        <div className={styles.legalContent}>
          <div className={`${styles.introText} ${styles.fadeIn}`}>
            <p>
              ブルートラック株式会社（以下「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下「本サービス」といいます。）における、
          ...
          <div className={`${styles.section} ${styles.fadeIn}`}>
            ...
            <div className={styles.sectionContent}>
              <p>
                ...
                クレジットカード番号、運転免許証番号などの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされた
          ...
          <div className={`${styles.section} ${styles.fadeIn}`}>
            ...
            <div className={styles.sectionContent}>
              ...
              <p>
                3. 当社は、前項の規定に基づき訂正等を行った場合、または訂正等を行わない旨の決定をしたときは遅滞なく、
                これをユーザーに通知します。
              </p>
            </div>
          </div>
